...
export function CommitmentForm({ onSubmitSuccess }: CommitmentFormProps) {
  ...
  return (
    <Card className="w-full max-w-sm sm:max-w-md bg-white/10 backdrop-blur-sm border border-white/20 shadow-xl">
      <CardHeader className="text-center p-4 sm:p-6 bg-transparent">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
          <CardContent className="space-y-4 px-4 sm:px-6 bg-transparent">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="text-left">
                  ...
                  <FormControl>
                    <Input placeholder="Your name" className="bg-white/10 backdrop-blur-sm border-white/20" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="text-left">
                  ...
                  <div className="flex h-10 w-full items-center rounded-md border border-white/20 bg-white/10 text-sm ring-offset-background backdrop-blur-sm focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2">
